...
using Multiplica.ApiRest.Validators;
using System;
...
namespace Multiplica.ApiRest.App_Start
{
  public static class WindsorConfig
  {
    public static IWindsorContainer Config()
    {
      ...
      container.Register(
        Component.For<ICommandHandler<TimelogTypePutOneCommand>>().ImplementedBy<TimelogTypePutOneValidator>().LifestyleTransient(),
      ...
      container.Register(
        Component.For<ICommandHandler<TimelogTypeGetOneCommand, TimelogTypeModel>>().ImplementedBy<TimelogTypeGetOneValidator>().LifestyleTransient(),
